...
class ContractEvmTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    if (transaction.ethereumData != null) {
      ethereumData = transaction.ethereumData;
    } else if (transaction.callData != null) {
    ...
    return _Transaction.default._fromProtobufTransactions(new ContractEvmTransaction({
      ethereumData,
      maxGas: transaction.maxGasAllowance != null ? transaction.maxGasAllowance : undefined
  ...
  /**
   * Set the ethereumData for this account.
   *
   * This is the ethereumData that must sign each transfer out of the account.
   *
   * If `receiverSignatureRequired` is true, then the ethereumData must also sign
