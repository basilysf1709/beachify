...
class Transaction extends _Executable.default {
  ...
  freezeWith(client) {
    ...
    this._signOnDemand = client != null ? client._signOnDemand : false; // Save the operator

    this._operator = client != null ? client._operator : null; // Set max transaction fee to either `this._maxTransactionFee`,
  ...
  async _beforeExecute(client) {
    ...
    this._operator = client != null ? client._operator : null; // If the client has an operaator, sign this request with the operator
  ...
  _shouldRetry(request, response) {
    ...
    _jsLogger.default.debug(`[${this._getLogId()}] received status ${status.toString()}`); // Based on the status what execution state are we in
