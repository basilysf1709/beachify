...
class Query extends _Executable.default {
  ...
  async _beforeExecute(client) {
    ...
    let cost = this._queryPayment; // Set cost to either the current max query payment, or the default on
    // client.
    ...
    this._queryPayment = cost; // FIXME: Shouldn't this be `!this._nodeAccountIds.locked`?
